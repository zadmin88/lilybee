...
const FamilyComponent = () => {
  return (
    <div className=" relative mb-48 mt-8 flex-col flex  lg:flex-row h-[800px] lg:mb-0 lg:my-8 lg:px-16">
      ...
      <Image
        ...
        width={800}
        height={800}
        className="xl:h-[600px] lg:h-[400px] md:h-[800px] md:w-full"
      />
      <Image
        src="/flowers.png"
        alt="Family"
        width={500}
        height={500}
        className="h-[500px] absolute bottom-40 right-0 top-0 lg:right-[400px] lg:top-[150px] xl:right-[500px] opacity-70 lg:opacity-90"
      />
    </div>
  );
};
